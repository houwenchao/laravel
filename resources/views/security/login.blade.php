...
<div class="loginWraper">
  <div id="loginform" class="loginBox">
    ...
    <form class="form form-horizontal" action="/login-check" method="post">
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          <input name="captcha[name]" class="input-text size-L" type="text" placeholder="验证码" onblur="if(this.value==''){this.value='验证码:'}" onclick="if(this.value=='验证码:'){this.value='';}" value="验证码:" style="width:150px;">
...
<script>
    document.getElementById('kanbuq').onclick=function(){
